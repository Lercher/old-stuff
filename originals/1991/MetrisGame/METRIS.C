...
#define	cls()		clrscr()
#define	goto_xy(x,y)	gotoxy((x)+1, (y)+1)
...
{	char in[100];
	...
	printf("  %-50s%s\r\n", "'7' ... Teil nach links schieben.",	"+-------+-------+-------+");
	printf("  %-50s%s\r\n", "'9' ... Teil nach rechts schieben.",	"| <---- | <---+ | ----> |");
	printf("  %-50s%s\r\n", "'8' ... Teil gegen die Uhr drehen.",	"|   7   |   8 | |   9   |");
	printf("  %-50s%s\r\n", "'5' ... Teil im Uhrzeigersinn drehen.",	"| <---- | ----+ | ----> |");
	printf("  %-50s%s\r\n", "SPC,'4' Teil fallen lassen.",		"+-------+-------+-------+");
	printf("  %-50s%s\r\n", "'6' ... Einen Level hîher.",		"| |   | | ----+ | Level |");
	printf("  %-50s%s\r\n", "ESC ... Quit.",				"| | 4 | |   5 | |   6   |");
	printf("  %-50s%s\r\n", "'p' ... Pause.",				"| V   V | <---+ | Level |");
	printf("  %-50s%s\r\n", "",					"+-------+-------+-------+");
	printf("  %-50s%s\r\n", "",					"|       |       |       |");
